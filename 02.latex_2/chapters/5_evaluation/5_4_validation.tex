...
各システム要求の検証結果を表\ref{tab:verification}にまとめる。
...
ID & 要求内容 & 目標値 & 達成値 \\
\midrule
SyR1 & 検出精度（mAP@0.5） & $\geq$ 92\% & 92.6\% \checkmark \\
SyR2 & 分類精度（Top-1 Acc.） & $\geq$ 85\% & 87.3\% \checkmark \\
SyR3 & 識別精度（Rank-1 Acc.） & $\geq$ 92\% & 93.4\% \checkmark \\
SyR4 & 処理速度（Mobile） & $\geq$ 30 FPS & 48 FPS \checkmark \\
SyR5 & モデルサイズ & $\leq$ 10 MB & 7.8 MB \checkmark \\
SyR6 & オンデバイス推論 & 対応 & 対応 \checkmark \\
\bottomrule
\end{tabular}
\end{table}
